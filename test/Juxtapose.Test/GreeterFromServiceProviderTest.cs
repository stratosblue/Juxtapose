...
namespace Juxtapose.Test
{
    ...
    public class GreeterFromServiceProviderTest
    {
        ...
        private GreeterIllusionFromIoCContainer CreateObject(out GreeterOrigin origin)
        {
            origin = _serviceProvider.GetRequiredService<GreeterOrigin>();
            return GreeterIllusionFromIoCContainer.NewAsync().GetAwaiter().GetResult();
        }
        ...
        protected static void PropCheck(GreeterOrigin origin, GreeterIllusionFromIoCContainer illusion)
        {
